  ...
  const getCensusData = async () => {
    try {
      const response = await AxiosInstance.get(
        `/census/get-census-for-rehab-for-today`
      );
      console.log(response.data.response, "rehab census data");
...
export default TotalRehabCensusTable;
